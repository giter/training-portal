...
module.exports = Vue.extend({
    ...
    methods:{
        ...
        renderHot: function (data) {
            ...
            var divIcon = new L.divIcon({html:data.table.seat+"座",className:"table-icon",iconSize:[30,20]});
        ...
        order: function () {
            ...
            Service.orderTable(this.table._id,JSON.stringify({
                ...
                setTimeout(function () {
                    layer.closeAll();
                    store.getOrders();
                    self.$router.replace("/food/"+rep._id);
                },1000);
            })
        }
    },
