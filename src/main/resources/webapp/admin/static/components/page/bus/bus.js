...
module.exports = Vue.extend({
   ...
   data: function () {
      return {
         ...
         bus:{
            ...
            "line":"",
            "online":1,
			"weeks":{"0":true,"1":true,"2":true,"3":true,"4":true,"5":true,"6":true},
   ...
   methods:{
      ...
      trans: function (bus) {
         var b = JSON.parse(JSON.stringify(bus));
         for(var i in b.weeks){
            if(b.weeks[i]){
               b.weeks[i] = 1;
            }else{
               b.weeks[i] = 0;
