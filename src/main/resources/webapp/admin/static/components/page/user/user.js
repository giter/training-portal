...
module.exports = Vue.extend({
   ...
   methods:{
      ...
      getUsers:function(param){
         var self = this;
         this.loading = true;
         Service.getUsers({page:self.page,limit:self.limit},function (rep) {
            self.loading = false;
            if(rep.Code == 0){
